...
public:
    ...
    // Applications use the animated purple/fuchsia/blue gradient.
    // Profiles and system buttons keep a quieter single-colour cursor.
...
private:
    float computeAdaptiveDuration(const nxui::Rect& target,
