#include "ProfileTitlePillWidget.hpp"
#include <nxui/core/Renderer.hpp>
#include <algorithm>

ProfileTitlePillWidget::ProfileTitlePillWidget() {
    setLiquidGlassShaderEnabled(false);
}

void ProfileTitlePillWidget::setText(const std::string& text, float screenWidth) {
...
void ProfileTitlePillWidget::hideAnimated(float screenWidth) {
...
void ProfileTitlePillWidget::onContentUpdate(float dt) {
    (void)dt;
...
void ProfileTitlePillWidget::onContentRender(nxui::Renderer& ren) {
...
nxui::Vec2 ProfileTitlePillWidget::computeContentSize() const {
